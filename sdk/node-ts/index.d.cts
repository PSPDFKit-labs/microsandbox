 ...
 */
export declare class EgressStream {
  /** Receive the next egress event. Returns `null` when the stream ends. */
  recv(): Promise<EgressEvent | null>
  /** Send a pass-through decision for the given event. */
  passThrough(eventId: number): Promise<void>
  /** Send a block decision for the given event. */
  block(eventId: number): Promise<void>
  /** Send a modified request decision. */
  modifyRequest(eventId: number, request: EgressHttpRequest): Promise<void>
  /** Send a short-circuit decision (return response to guest, skip server). */
  shortCircuit(eventId: number, response: EgressHttpResponse): Promise<void>
  /** Send a modified response decision. */
  modifyResponse(eventId: number, response: EgressHttpResponse): Promise<void>
}
export type JsEgressStream = EgressStream
...
export declare class Sandbox {
   ...
   */
  egressConnection(): Promise<JsEgressStream>
}
...
export interface NetworkConfig {
   ...
   */
  egressInterceptTimeoutMs?: number
  /**
